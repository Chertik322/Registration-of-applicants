    ...
    if (isset($_POST['student_id']) && isset($_POST['specialization_id'])) {
        ...
        if ($student_exists) {
            ...
            if ($specialization_exists) {
                ...
                $specialization_already_exists = CheckSpecializationByStudent_MAG($connection, $student_id, $specialization_id);
                ...
                $result = insertSpecializationToStudent_MAG($connection, $student_id, $specialization_id);
                ...
                if ($result) {
                    ...
                    $log_result = addActionToLog_MAG($connection, $student_id, $specialization_name);
