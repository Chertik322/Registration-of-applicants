...
function updateStudentData_MAG($connection, $student_id, $column, $lastName, $firstName, $middleName, $phoneNumber, $description, $foreign_language, $rezults)
{
    ...
    if ($column === 'name') {
        ...
        $query = "UPDATE Students_MAG SET last_name = ?, first_name = ?, middle_name = ? WHERE student_id = ?";
        ...
        $query = "UPDATE Students_MAG SET phone_number = ? WHERE student_id = ?";
        $statement = mysqli_prepare($connection, $query);
        if ($statement) {
        ...
        $query = "UPDATE Students_MAG SET description = ? WHERE student_id = ?";
        $statement = mysqli_prepare($connection, $query);
        if ($statement) {
        ...
        $query = "UPDATE Students_MAG SET foreign_language = ? WHERE student_id = ?";
        $statement = mysqli_prepare($connection, $query);
        if ($statement) {
    ...
    elseif ($column === 'rezults') {
        $query = "UPDATE Students_MAG SET rezults = ? WHERE student_id = ?";
        $statement = mysqli_prepare($connection, $query);
        if ($statement) {
...
if (isset($_POST['column'])) {
    ...
    updateStudentData_MAG($connection, $student_id, $column, $lastName, $firstName, $middleName, $phoneNumber, $description, $foreign_language, $rezults);
}
?>
