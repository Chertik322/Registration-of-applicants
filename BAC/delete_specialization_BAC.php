    ...
    if (isset($_POST['student_id']) && isset($_POST['specialization_id'])) {
        ...
        if ($student_exists) {
            ...
            if ($specialization_exists) {
                ...
                $result = deleteSpecializationFromStudent_BAC($connection, $student_id, $specialization_id);
...
$log_result = delActionToLog_BAC($connection, $student_id, $specialization_name);
if (!$log_result) {
