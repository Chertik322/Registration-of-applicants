...
function addActionToLogIco_MAG($connection, $student_id, $iconType, $userName) {
    $action = "$userName заходил(а) в $iconType с данным абитуриентом";
    $query = "INSERT INTO action_log_MAG (student_id, `description`) VALUES (?, ?)";
...
$result = addActionToLogIco_MAG($connection, $studentId, $iconType,$userName);
