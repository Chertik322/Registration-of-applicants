...
function addActionToLogIco($connection, $student_id, $iconType, $userName) {
    $action = "$userName заходил(а) в $iconType с данным абитуриентом";
    $query = "INSERT INTO action_log_SPO (student_id, `description`) VALUES (?, ?)";
...
$result = addActionToLogIco($connection, $studentId, $iconType, $userName);
